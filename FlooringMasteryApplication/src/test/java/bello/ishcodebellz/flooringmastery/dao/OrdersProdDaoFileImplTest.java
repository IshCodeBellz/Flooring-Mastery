...
import bello.ishcodebellz.flooringmasteryapplication.dao.FMAOrdersProdDaoFileImpl;
...
public class OrdersProdDaoFileImplTest {
    ...
    private FMAOrdersDao ordersDao = new FMAOrdersProdDaoFileImpl(dataFolder);
    ...
    public void testAddGetOrders() throws Exception {
        ...
        List<FMAOrder> initialOrders = ordersDao.getOrders(date);
        ...
        List<FMAOrder> fromDao = ordersDao.getOrders(order.getDate());
   ...
   /* @Test
    public void testRemoveOrder() throws Exception {
        ...
        ordersDao.cancelOrder(order2);

        List<FMAOrder> fromDao = ordersDao.getOrders(date);
