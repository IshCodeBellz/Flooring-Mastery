 ...
 */
package bello.ishcodebellz.flooringmasteryapplication.dto;
...
public class FMAOrder {
    ...
    private BigDecimal materialCost;//set
    private BigDecimal laborCost;//set
    private BigDecimal tax;// set
    private BigDecimal total; //set
    ...
    public boolean equals(Object obj) {
        ...
        final FMAOrder other = (FMAOrder) obj;
